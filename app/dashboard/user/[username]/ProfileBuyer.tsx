                        ...
                        {reviews.length > 0 ? (
                            <div className="flex flex-col gap-4">
                                {reviews.map((review: any) => (
                                    <div key={review.id} className="p-6 rounded-2xl border border-border bg-card shadow-sm hover:shadow-md transition-all">
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div className="flex flex-col gap-1">
                                                    <div className="flex items-center gap-2">
                                                        <span className="font-bold text-sm">@{review.author?.username}</span>
                                                    ...
                                                    <p className="font-medium text-foreground mt-1 text-[15px]">{review.comment || review.text}</p>
                                                    <p className="text-xs text-muted-foreground mt-2">
                                                        {review.serviceTitle ? (
                                                            <>For: <span className="font-bold">"{review.serviceTitle}"</span></>
                                                        ) : review.service?.title ? (
                                                            <>For: <span className="font-bold">"{review.service.title}"</span></>
                                                        ) : (
                            ...
                            <div className="rounded-xl border border-border/60 bg-muted/30 py-16 px-8">
                                <div className="text-center max-w-md mx-auto">
                                    ...
                                    <p className="text-muted-foreground text-sm">
                                        {user.isOwnProfile
                                            ? "Feedback from freelancers you've worked with will appear here."
                                ...
                                <div className="lg:col-span-6 space-y-10 lg:pl-10 border-l border-[#F8F8F8] lg:border-l-0 lg:ml-0">
                                    <div className="space-y-5">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            {/* Languages */}
                                            <div className="space-y-4">
                                                <p className="text-[12px] font-bold text-slate-400 uppercase tracking-widest leading-none mt-4">Languages</p>
                                                {(user.languages || []).map((lang: any, idx) => (
                                                    <div key={idx} className="flex items-center justify-between group">
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <span className="text-[17px] font-medium text-slate-700">{lang.proficiency} in {lang.name}</span>
                                                        </div>
